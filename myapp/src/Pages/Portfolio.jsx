...
export default function Portfolio(){
    ...
    return (
        ...
        <div className="portfolio">
            ...
            <Part link="./portfolio/games"  title="Games & Visualizations" image="https://images.pexels.com/photos/1114883/pexels-photo-1114883.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1"></Part>
        </div>
        </>
    )
}