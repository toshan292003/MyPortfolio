...
export default function Portfolio(){
    ...
    return (
        ...
        <div className="portfolio">
            ...
            <Part link="./portfolio/cinema"  title="Cinematography" image="https://images.pexels.com/photos/821749/pexels-photo-821749.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1"></Part>
        </div>
        </>
    )
}